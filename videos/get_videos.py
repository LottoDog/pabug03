...
'''
//*[@id="post_content_120739818179"]/div/div/video/@src
...
*xpath  
    ...
    视频图片
            ...
            //*[@class="video_src_wrap_main"]/video/@src
            但是发现搜索为空
            因为在加载完的静态源代码中标签为属性data-video
            
            更改
            //div[@class="video_src_wrap_main"]/embed/@data-video
            或者 
            
            //*[@class="video_src_wrap_main"]/embed/@data-video
